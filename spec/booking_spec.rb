...
describe Booking do 
  describe '.add' do 
    it 'creates a booking request' do 
      host = DatabaseConnection.query("INSERT INTO users (id) VALUES ($1)", [1])
      customer = DatabaseConnection.query("INSERT INTO users (id) VALUES ($1)", [2])
  ...
  describe '.all_booking_made' do
    it 'shows the Booking requested by the customer' do
      #connected to the database and created a host user with user_id 1 
      host = DatabaseConnection.query("INSERT INTO users (id) VALUES ($1)", [1])
  ...
  describe '.all_booking_received' do
    it 'shows all the booking requests received by the host' do
      #connected to the database and created a host with user_id 1
      host = DatabaseConnection.query("INSERT INTO users (id) VALUES ($1)", [1])
