...
describe Booking do 
  ...
  describe '.all' do 
    it 'show all Booking' do
      ...
      booking = Booking.add(space_id: 1, host_id: 1, customer_id: 2, start_date: '2022-01-01', end_date: '2022-01-31', status: 'requested' ).first
  ...
  describe '.all_booking_made' do
    it 'shows the Booking requested by the customer' do
      ...
      booking = Booking.add(space_id: "#{space.space_id}", host_id: "#{space.host_id}", customer_id: 2, start_date: '2022-01-01', end_date: '2022-01-31', status: 'requested' )
      Booking.add(space_id: "#{space.space_id}", host_id: "#{space.host_id}", customer_id: 2, start_date: '2022-02-02', end_date: '2022-02-22', status: 'requested' )
      Booking.add(space_id: "#{space.space_id}", host_id: "#{space.host_id}", customer_id: 99, start_date: '2022-02-02', end_date: '2022-02-22', status: 'requested' )
